      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="container">
          <div class="page-header">
            <h1>CRSystem | Petición CRID000248</h1>
          </div>
          <div class="panel panel-default">

            <div class="panel-heading">Tarjeta del cambio | CRID000248 </div>
            <div class="panel-body">
              <div class="alert alert-warning alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                Esta tarjeta sólo es editable mientras no esté asignado. Una vez que el CR halla sido asignado esto sólo será de 
                visualización.
              </div>
            </div>
            ...
            <div class="box-form">
              <form class="form-horizontal" role="form">
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">No. CRID</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputPassword3" value="CRID000248" disabled>
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Fecha de creación</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputPassword3" value="20 de Enero, 2014 13:45 Hrs" disabled>
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Asignación</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputPassword3" value="Sin asignación" disabled>
                  </div>
                </div>
                <div class="form-group">
